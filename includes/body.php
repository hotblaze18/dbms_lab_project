<body>
      ...
      <div class="row d-flex">
        ...
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-2">
              <h3 class="heading mb-3">Great Learning Experience</h3>
        ...
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-2">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, a.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="about" class="py-5">
    <div class="row">
      <div class="col p-4">
        <div class="container">
          <h2 class="text-center mb-3 text-danger display-3">About</h3>
            <p class="lead text-justify">Tech Fest is an Amazing Technical Festival held at BMS college of engineering Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad quis illum pariatur nesciunt asperiores quam maiores odit optio quas excepturi!</p>
        </div>
      </div>
      <div class="col">
        <img src="images/cs01.jpg" style="width:100%;height:400px;">
      </div>
    </div>
  </section>
                      ...
                      while ($row = mysqli_fetch_array($run_query2)) {
                        ...
                        if ($newtype_id == $type_id) {
                          ...
                          echo "
                                   ...
                                   <div class='destination'>
                                     <a href='#' class='img img-2 d-flex justify-content-center align-items-center' style='background-image: url(./$img_link);'>
                                     ...
                                     <div class='text p-3'>
                                       ...
                                       <p class='bottom-area d-flex'>   
                                         <span class='ml-auto'>
                                         <form action='register.php' target='_blank' method='GET'>
                                          <input type='hidden' value=$event_id name='re_id'>
