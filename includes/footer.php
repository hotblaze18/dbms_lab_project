      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker"></span><span class="text">BMS College of Engineering</span></li>
              <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9596342174</span></a></li>
              <li><a href="#"><span class="icon icon-envelope"></span><span class="text">techfest2k20@gmail.com</span></a></li>
            </ul>
          </div>
        </div>
      </div>
...
<div class="chat-popup" id="myForm" style="border-radius:30px;">
  <form id="message_form" class="form-container" style="border-radius:30px;">
    <h1>Get in touch</h1>
    <p id="message_text"></p>
